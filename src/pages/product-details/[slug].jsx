...
function ProductDetails() {
    ...
    const getProductDetail = async () => {
        const data = await productUIService.takeProductDetail(router.query.slug)
        console.log(data);
        setProduct(data)
    }
    return (
        ...
        <div className="w-full h-full flex flex-col py-[80px] gap-5 px-page">
            ...
            <div className="flex flex-row gap-10">
                <div className="flex flex-col gap-4 items-center">
                    ...
                    <Image src={product.thumbnail} alt="Brand Photo Thumbnail" width={520} height={450} className='rounded-xl' />
                    </div>
                    <div className="flex flex-row w-full justify-between gap-4 items-center">
                        ...
                        <div className='h-[117px] w-[136px] bg-orange-100 rounded-2xl flex items-center justify-center'>
                            <Image src={product.images?.[0]} alt="Brand Photo 1" width={100} height={130} className="rounded-lg" />
                        </div>
                        <div className='h-[117px] w-[136px] bg-orange-100 rounded-2xl flex items-center justify-center'>
                            <Image src={product.images?.[1]}  alt="Brand Photo 2" width={100} height={130} className="rounded-lg" />
                        </div>
                        <div className='h-[117px] w-[136px] bg-orange-100 rounded-2xl flex items-center justify-center'>
                            <Image src={product.images?.[2]}  alt="Brand Photo 3" width={100} height={130} className="rounded-lg" />
                        </div>
                ...
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col gap-0">
                        ...
                        <span className="font-light text-lg text-gray-300">{product.stock} in stock | %{product.discountPercentage} discount</span>
                    </div>
                    <div className="flex flex-row gap-2 items-center">
                        <Rating value={+product.rating} readOnly emptyIcon={<StarIcon style={{ opacity: 0.55 }} fontSize="inherit" />} size="large" />
                        <span className="text-xl font-bold">{product.rating} <span className=' font-light text-gray-400 text-lg'>rating</span></span>
                    </div>
                    ...
                    <ul className="flex flex-col gap-2">
                        ...
                        <li className='flex flex-row gap-2 items-center'>
                            <CheckCircleOutlineOutlinedIcon className='w-[30px] h-[30px]' />
                            <span className='text-lg font-light'>Brand: {product.brand}</span>
                        </li>
                        <li className='flex flex-row gap-2 items-center'>
                            <CheckCircleOutlineOutlinedIcon className='w-[30px] h-[30px]' />
                            <span className='text-lg font-light'>Category: {product.category}</span>
                        </li>
                        <li className='flex flex-row gap-2 items-center'>
                            <CheckCircleOutlineOutlinedIcon className='w-[30px] h-[30px]' />
                            <span className='text-lg font-light'>{product.stock} in stock</span>
                        </li>
                    </ul>
